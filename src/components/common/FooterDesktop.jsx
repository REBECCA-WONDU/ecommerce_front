...
import Goggle from "../../asset/images/google.png";
    ...
    axios
      ...
      .then((response) => {
        ...
        if (StatusCode === 200) {
          ...
          // Log the data you're setting in the state
          this.setState({
    ...
    return (
      <Fragment>
        <div className="footerback m-0 mt-5 pt-3 shadow-sm">
            ...
            <Row className="px-0 my-5">
              <Col className="p-2" lg={3} md={3} sm={6} xs={12}>
                ...
                <a href={this.state.twitter_link} target="_blank">
                  ...
                  {/* <i className="fa-brands m-1 h4 fa-x-twitter"></i> */}
                </a>
              </Col>
          ...
          <Container
            fluid={true}
            className="text-center mt-0 pt-3 pb-1 bg-dark"
          >
            <Container>
              <Row>
